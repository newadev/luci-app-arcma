...
[![OpenWrt Stable/Old Stable/Snapshots](https://img.shields.io/badge/OpenWrt-Stable%2FOld%20Stable%2FSnapshots-green.svg)](https://openwrt.org)
...
- OpenWrt Stable、OpenWrt Old Stable 或 OpenWrt Development Snapshots。
- `ip-full`，由包依赖自动选择。
